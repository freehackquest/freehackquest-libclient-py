...
import traceback
import websocket
from freehackquest_libclient_py.freehackquest_api_games import FreeHackQuestApiGames
from freehackquest_libclient_py.freehackquest_api_leaks import FreeHackQuestApiLeaks
from freehackquest_libclient_py.freehackquest_api_quests import FreeHackQuestApiQuests
from freehackquest_libclient_py.freehackquest_api_quests_files import FreeHackQuestApiQuestsfiles
from freehackquest_libclient_py.freehackquest_api_server import FreeHackQuestApiServer

class FreeHackQuestClient:
    """Client Api for fhq-server"""
    __ws = None
    __url = None
    __cli_version = 'v0.2.54'
    __loop = None
    __connecting = False
    ...
    def __init__(self, url):
        self.__url = url
        self.games = FreeHackQuestApiGames(self)
        self.leaks = FreeHackQuestApiLeaks(self)
        self.quests = FreeHackQuestApiQuests(self)
        self.quests_files = FreeHackQuestApiQuestsfiles(self)
        self.server = FreeHackQuestApiServer(self)
            ...
            if ready[0]:
                ...
                if 'm' in response_json:
                    ...
                    if income_message_id == message_id:
                        return response_json
                    self.__incoming_messsages.append(response_json)
                elif 'id' in response_json and 'jsonrpc' in response_json:
                    income_message_id = response_json['id']
                    if income_message_id == message_id:
                        return response_json
                    self.__incoming_messsages.append(response_json)
                else:
    ...
    def game_create(self, req):
        """Create the game
            ...
            Permissins:
                ...
                Denied access for admins
            Args:
                freehackquest_game_format_version (integer,required):
                    Format Version
        ...
        allowed_params = [
            'freehackquest_game_format_version',
            'uuid',
            'name',
            'description',
            'state',
        ...
        if 'freehackquest_game_format_version' in req:
            request_json['freehackquest_game_format_version'] = req['freehackquest_game_format_version']
        if 'uuid' in req:
            request_json['uuid'] = req['uuid']
        if 'name' in req:
            request_json['name'] = req['name']
    ...
    def games_list(self, req):
        ...
        if not self.has_connection():
            return None
        request_json = self.generate_base_command('games_list')
        allowed_params = []
        self.check_on_excess_params(req, 'games_list', allowed_params)
        return self.send_command(request_json)
